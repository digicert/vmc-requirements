...
*Common Mark Certificate:* A Mark Certificate that is either a Prior Use Mark Certificate or a Modified Registered Trademark Certificate. 
...
*Designated Individual:* The person who completes tny of the verification procedures described in <<_additional_f2f_verification_procedure>>.
...
*Mark Verifying Authority (“MVA”):* The authority who issues a Mark Certificate or Mark Certificate. Also referred to as a Certification Authority or CA.
