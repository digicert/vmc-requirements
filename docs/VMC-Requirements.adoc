...
. *Certificate field:* subject:goodAndServiceCategory (OID: 1.3.6.1.4.1.53087.1.14)
+
* *Optional*
+
*Contents:* This field MUST contain the Nice Classification (TODO: Add defined term and reference) of the Subject.
